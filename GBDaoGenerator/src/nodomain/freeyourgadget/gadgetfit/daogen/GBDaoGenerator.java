 ...
 */
package nodomain.freeyourgadget.gadgetfit.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String LEGACY_DIR = "app/src/main/java/nodomain/freeyourgadget/gadgetfit/entities";

    private static final String VALID_FROM_UTC = "validFromUTC";
    private static final String VALID_TO_UTC = "validToUTC";
    private static final String MAIN_PACKAGE = "nodomain.freeyourgadget.gadgetfit";
    ...
    private static void deleteOldFiles() throws IOException {
        ...
        // FIXME: Remove this eventually, and app/src/main/java/nodomain/freeyourgadget/gadgetfit/entities/.gitignore as well
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("nodomain.freeyourgadget.gadgetfit.model.Alarm");
    ...
    private static void addReminders(Schema schema, Entity user, Entity device) {
        ...
        reminder.implementsInterface("nodomain.freeyourgadget.gadgetfit.model.Reminder");
    ...
    private static void addWorldClocks(Schema schema, Entity user, Entity device) {
        ...
        worldClock.implementsInterface("nodomain.freeyourgadget.gadgetfit.model.WorldClock");
    ...
    private static void addContacts(Schema schema, Entity user, Entity device) {
        ...
        contact.implementsInterface("nodomain.freeyourgadget.gadgetfit.model.Contact");
    ...
    private static final String SAMPLE_PROVIDER_TEMPLATE = """
            ...
            import nodomain.freeyourgadget.gadgetfit.entities.${classNameSample};
            import nodomain.freeyourgadget.gadgetfit.entities.${classNameDao};
    ...
    private static void generateSampleProvider(final Entity entity) throws IOException {
        final File outputDir = new File(OUTPUT_DIR + "/nodomain/freeyourgadget/gadgetfit/devices");
