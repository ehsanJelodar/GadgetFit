...
package nodomain.freeyourgadget.gadgetfit.webview;
...
import nodomain.freeyourgadget.gadgetfit.internet.InternetFirewall;
...
public class GBWebClient extends WebViewClient {
    ...
    private WebResourceResponse mimicReply(Uri requestedUri, String method, Map<String, String> requestHeaders) {
        ...
        if (requestedUri.toString().startsWith("file://") || requestedUri.toString().startsWith("gadgetfit://")) {
            return null;
        }
