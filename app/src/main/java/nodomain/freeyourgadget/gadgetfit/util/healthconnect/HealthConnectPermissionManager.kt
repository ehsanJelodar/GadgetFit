...
import nodomain.freeyourgadget.gadgetfit.activities.HealthConnectResetDialogFragment
...
object HealthConnectPermissionManager {
    ...
    fun isHealthConnectEnabled(context: Context): Boolean {
        ...
        if (!prefs.getBoolean(nodomain.freeyourgadget.gadgetfit.util.GBPrefs.HEALTH_CONNECT_ENABLED, false)) {
            return false
        }
