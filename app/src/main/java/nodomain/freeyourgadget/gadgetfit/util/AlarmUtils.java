...
public class AlarmUtils {
     ...
     * @return
     */
    public static nodomain.freeyourgadget.gadgetfit.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(nodomain.freeyourgadget.gadgetfit.model.Alarm alarm) {
