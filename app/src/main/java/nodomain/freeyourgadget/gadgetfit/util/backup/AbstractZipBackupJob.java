...
package nodomain.freeyourgadget.gadgetfit.util.backup;
...
import nodomain.freeyourgadget.gadgetfit.util.gson.GsonUtcDateAdapter;

public abstract class AbstractZipBackupJob implements Runnable {
    public static final String METADATA_FILENAME = "gadgetfit.json";
    public static final String DATABASE_FILENAME = "database/gadgetfit";
