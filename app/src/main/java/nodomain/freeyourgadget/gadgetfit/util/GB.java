...
package nodomain.freeyourgadget.gadgetfit.util;

import static nodomain.freeyourgadget.gadgetfit.GBApplication.isRunningOreoOrLater;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceService.EXTRA_RECORDED_DATA_TYPES;
...
import nodomain.freeyourgadget.gadgetfit.GBEnvironment;
...
public class GB {
    public static final String ACTION_ACTIVITY_SYNC = "nodomain.freeyourgadget.gadgetfit.action.ACTIVITY_SYNC_FINISH";

    public static final String NOTIFICATION_CHANNEL_ID = "gadgetfit";
    public static final String NOTIFICATION_CHANNEL_ID_CONNECTION_STATUS = "gadgetfit connection status";
    public static final String NOTIFICATION_CHANNEL_ID_SCAN_SERVICE = "gadgetfit_scan_service";
    public static final String NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID = "gadgetfit_high_priority";
    public static final String NOTIFICATION_CHANNEL_ID_TRANSFER = "gadgetfit transfer";
    public static final String NOTIFICATION_CHANNEL_ID_EXPORT = "gadgetfit export";
        ...
        if (devices.isEmpty()){
           ...
           //=  text += buildDeviceBatteryString(context, device);
            ...
            builder.setContentTitle(deviceName)
                    ...
                    .setContentText(text)
                    .setSmallIcon(isConnected ? device.getNotificationIconConnected() : device.getNotificationIconDisconnected())
                    .setContentIntent(getContentIntent(context))
                    .setShowWhen(false)
                    .setOngoing(true);
    ...
    /**
     * @deprecated use {@link nodomain.freeyourgadget.gadgetfit.util.notifications.GBProgressNotification}
     */
    @Deprecated
