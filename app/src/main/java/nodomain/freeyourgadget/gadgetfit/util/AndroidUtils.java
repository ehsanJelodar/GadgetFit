    ...
    public static String getTextColorHex(Context context) {
        ...
        if (DynamicColors.isDynamicColorAvailable() && GBApplication.areDynamicColorsEnabled()) {
            ...
            if (GBApplication.isDarkThemeEnabled()) {
                dynamicColorContext = DynamicColors.wrapContextIfAvailable(context, R.style.gadgetfitThemeDynamicDark);
            } else {
                dynamicColorContext = DynamicColors.wrapContextIfAvailable(context, R.style.gadgetfitThemeDynamicLight);
            }
    ...
    */
    ...
    public static PowerManager.WakeLock acquirePartialWakeLock(Context context, String tag, long timeout) {
        try {
            ...
            PowerManager.WakeLock wl = powermanager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "gadgetfit:" + tag);
            wl.acquire(timeout);
            return wl;
