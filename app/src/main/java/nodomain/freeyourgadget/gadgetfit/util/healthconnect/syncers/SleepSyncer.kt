...
import nodomain.freeyourgadget.gadgetfit.activities.charts.SleepAnalysis
...
internal object SleepSyncer : ContextualActivitySampleSyncer {
    ...
    private fun sleepSessionToRecord(
        ...
        return SleepSessionRecord(
            ...
            title = context.getString(nodomain.freeyourgadget.gadgetfit.R.string.health_connect_sleep_session_title, deviceName),
            notes = context.getString(nodomain.freeyourgadget.gadgetfit.R.string.health_connect_sleep_session_notes, deviceName),
            stages = stages,
            metadata = metadata
        )
    }
