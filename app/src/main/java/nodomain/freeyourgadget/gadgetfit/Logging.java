...
public abstract class Logging {
    ...
    public void setupLogging(boolean enable) {
        try {
            ...
            getLogger().info("gadgetfit version: {}-{} {} {}", BuildConfig.VERSION_NAME,
...
//        Logger logger = LoggerFactory.getLogger(Logging.class);
    ...
    public static FileAppender createFileAppender(final String logDirectory) {
        ...
        rollingPolicy.setFileNamePattern(logDirectory + "/gadgetfit-%d{yyyy-MM-dd}.%i.log.zip");
        ...
        fileAppender.setFile(logDirectory + "/gadgetfit.log");
