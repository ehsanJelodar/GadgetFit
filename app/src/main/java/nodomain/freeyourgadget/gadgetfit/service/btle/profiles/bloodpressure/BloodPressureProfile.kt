package nodomain.freeyourgadget.gadgetfit.service.btle.profiles.bloodpressure
...
import nodomain.freeyourgadget.gadgetfit.util.kotlin.getSFloat
...
class BloodPressureProfile<T : AbstractBTLESingleDeviceSupport>(val support: T) : AbstractBleProfile<T>(support) {
    ...
    companion object {
        ...
        const val ACTION_BLOOD_PRESSURE = "nodomain.freeyourgadget.gadgetfit.ble.profile.ACTION_BLOOD_PRESSURE"
