...
package nodomain.freeyourgadget.gadgetfit.service.devices.banglejs;
...
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BANGLEJS_TEXT_BITMAP;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BANGLEJS_TEXT_BITMAP_SIZE;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_UPDATE;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_UPDATE_INTERVAL;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_GPS_USE_NETWORK_ONLY;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_INTENTS;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DEVICE_INTERNET_ACCESS;
import static nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_NOTIFICATION_WAKE_ON_OPEN;
import static nodomain.freeyourgadget.gadgetfit.database.DBHelper.getUser;
import static nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSConstants.PREF_BANGLEJS_ACTIVITY_FULL_SYNC_START;
import static nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSConstants.PREF_BANGLEJS_ACTIVITY_FULL_SYNC_STATUS;
import static nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSConstants.PREF_BANGLEJS_NOTIFICATION_MISSED_CALL_ENABLE;
...
import nodomain.freeyourgadget.gadgetfit.activities.WakeActivity;
import nodomain.freeyourgadget.gadgetfit.activities.devicesettings.DeviceSettingsPreferenceConst;
import nodomain.freeyourgadget.gadgetfit.capabilities.loyaltycards.BarcodeFormat;
...
import nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSConstants;
import nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSSampleProvider;
import nodomain.freeyourgadget.gadgetfit.entities.BangleJSActivitySample;
import nodomain.freeyourgadget.gadgetfit.entities.CalendarSyncState;
import nodomain.freeyourgadget.gadgetfit.entities.CalendarSyncStateDao;
...
import nodomain.freeyourgadget.gadgetfit.service.btle.BtLEQueue;
...
import nodomain.freeyourgadget.gadgetfit.util.LimitedQueue;
...
public class BangleJSDeviceSupport extends AbstractBTLESingleDeviceSupport {
    ...
    private void setSleepAsAndroidAlarm(long alarmTimestamp) {
        ...
        nodomain.freeyourgadget.gadgetfit.entities.Alarm currentAlarm = DBHelper.getAlarms(gbDevice).get(SleepAsAndroidSender.getAlarmSlot());
    ...
    private void handleHttp(JSONObject json) throws JSONException {
        ...
        if (!GBApplication.hasInternetAccess()) {
            uartTxJSONError("http", "Internet access not enabled in gadgetfit", id);
            return;
        }
    ...
    private void handleIntent(JSONObject json) throws JSONException {
        ...
        if (!devicePrefs.getBoolean(PREF_DEVICE_INTENTS, false)) {
            uartTxJSONError("intent", "Android Intents not enabled, check gadgetfit Device Settings", null);
            return;
        }
        ...
        if (json.has("package") && !json.has("class")) {
            in = json.getString("package").equals("gadgetfit") ?
