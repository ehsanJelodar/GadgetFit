...
package nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.adapter.fossil;

import static nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.QHybridSupport.ITEM_STEP_GOAL;
import static nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.QHybridSupport.ITEM_TIMEZONE_OFFSET;
import static nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.QHybridSupport.ITEM_VIBRATION_STRENGTH;
import static nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_BUTTON_PRESS;
import static nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_MULTI_BUTTON_PRESS;
...
import nodomain.freeyourgadget.gadgetfit.devices.qhybrid.NotificationConfiguration;
import nodomain.freeyourgadget.gadgetfit.devices.qhybrid.PackageConfigHelper;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.adapter.WatchAdapter;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.buttonconfig.ConfigFileBuilder;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.buttonconfig.ConfigPayload;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.Request;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.alarm.AlarmsSetRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.configuration.ConfigurationPutRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.device_info.DeviceInfo;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.device_info.DeviceSecurityVersionInfo;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.device_info.GetDeviceInfoRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.device_info.SupportedFileVersionsInfo;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.file.FileDeleteRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.file.FileLookupAndGetRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.file.FilePutRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.file.FirmwareFilePutRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.notification.NotificationFilterPutRequest;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.AnimationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.ReleaseHandsControlRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.RequestHandControlRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.SaveCalibrationRequest;
...
public class FossilWatchAdapter extends WatchAdapter {
    ...
    @Override
    public void vibrate(nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.misfit.PlayNotificationRequest.VibrationType vibration) {
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
        ...
        if (alarms.size() == 1 && alarms.get(0).getRepetition() == 0) { //single shot?
            ...
            alarms = (ArrayList<? extends Alarm>) AlarmUtils.mergeOneshotToDeviceAlarms(getDeviceSupport().getDevice(), (nodomain.freeyourgadget.gadgetfit.entities.Alarm) oneshot, 5);
        }

        ArrayList<nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.alarm.Alarm> activeAlarms = new ArrayList<>();
        for (Alarm alarm : alarms) {
            if (!alarm.getEnabled() || alarm.getUnused()) continue;
            if (alarm.getRepetition() == 0) {
                activeAlarms.add(new nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.alarm.Alarm(
        ...
        queueWrite(new AlarmsSetRequest(activeAlarms.toArray(new nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.requests.fossil.alarm.Alarm[0]), this) {
            @Override
            public void onFilePut(boolean success) {
                super.onFilePut(success);
