...
package nodomain.freeyourgadget.gadgetfit.service.btbr;
...
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.FunctionAction;
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.SetProgressAction;
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.WaitAction;
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.WriteAction;
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.SetDeviceStateAction;
import nodomain.freeyourgadget.gadgetfit.service.btbr.actions.SetDeviceBusyAction;
...
public class TransactionBuilder {
    ...
    public TransactionBuilder write(byte... data) {
        if (data == null) {
            ...
            LOG.error("Attempting to write null data - this is likely a bug in gadgetfit", e);
