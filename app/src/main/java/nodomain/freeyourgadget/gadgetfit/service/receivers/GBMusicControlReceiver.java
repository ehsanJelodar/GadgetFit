...
package nodomain.freeyourgadget.gadgetfit.service.receivers;
...
public class GBMusicControlReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_MUSICCONTROL = "nodomain.freeyourgadget.gadgetfit.musiccontrol";
