...
package nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman;

import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_ACTIVATE_AIRPLANE_MODE;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_BREATHING_START;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_BREATHING_STOP;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_CHECK_DATA;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_DISABLE_SPO2;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_ENABLE_SPO2;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_EXERCISE_START;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_EXERCISE_STOP;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_GET_FIRST_RECORDING_NR;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_GET_LAST_RECORDING_NR;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_GET_RECORDINGS;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_RESET;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.OPERATION_SETTIME;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.UUID_COMMAND;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.UUID_DATA;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.UUID_RESPONSE;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.UUID_STATE;
import static nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants.UUID_TODO;
import static nodomain.freeyourgadget.gadgetfit.impl.GBDevice.State.INITIALIZED;
import static nodomain.freeyourgadget.gadgetfit.impl.GBDevice.State.INITIALIZING;
import static nodomain.freeyourgadget.gadgetfit.model.TemperatureSample.LOCATION_FINGER;
import static nodomain.freeyourgadget.gadgetfit.model.TemperatureSample.TYPE_SKIN;
import static nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman.UltrahumanCharacteristic.COMMAND;
import static nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman.UltrahumanCharacteristic.DATA;
import static nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman.UltrahumanCharacteristic.RESPONSE;
import static nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman.UltrahumanCharacteristic.STATE;
import static nodomain.freeyourgadget.gadgetfit.service.devices.ultrahuman.UltrahumanCharacteristic.TODO;
...
import nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanConstants;
import nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanExercise;
import nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.UltrahumanExerciseData;
import nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.samples.UltrahumanActivitySampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.ultrahuman.samples.UltrahumanDeviceStateSampleProvider;
import nodomain.freeyourgadget.gadgetfit.entities.DaoSession;
import nodomain.freeyourgadget.gadgetfit.entities.GenericHeartRateSample;
import nodomain.freeyourgadget.gadgetfit.entities.GenericHrvValueSample;
import nodomain.freeyourgadget.gadgetfit.entities.GenericSpo2Sample;
import nodomain.freeyourgadget.gadgetfit.entities.GenericStressSample;
import nodomain.freeyourgadget.gadgetfit.entities.GenericTemperatureSample;
import nodomain.freeyourgadget.gadgetfit.entities.UltrahumanActivitySample;
import nodomain.freeyourgadget.gadgetfit.entities.UltrahumanDeviceStateSample;
