...
package nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.MessageId;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.ParameterId;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.ReportState;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.SensorType;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.message.GetSensorRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.message.Response;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.message.SetSensorRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.parameter.Parameter;
import nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.parameter.SensorState;
...
public class BinarySensorSupport extends BinarySensorBaseSupport {
    ...
    final public static String ACTION_SENSOR_STATE_CHANGED = "nodomain.freeyourgadget.gadgetfit.binary_sensor.STATE_CHANGED";
    final public static String ACTION_SENSOR_STATE_REQUEST = "nodomain.freeyourgadget.gadgetfit.binary_sensor.STATE_REQUEST";

    private static final Logger logger = LoggerFactory.getLogger(BinarySensorSupport.class);

    private nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.SensorState sensorState = null;
    ...
    void sendStateChangeIntent(boolean sendGlobally){
        ...
        intent.putExtra("EXTRA_SENSOR_CLOSED", sensorState == nodomain.freeyourgadget.gadgetfit.service.devices.binary_sensor.protocol.constants.SensorState.SENSOR_STATE_CLOSED);
