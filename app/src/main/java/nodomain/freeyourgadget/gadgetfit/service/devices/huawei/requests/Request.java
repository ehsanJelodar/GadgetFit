...
public class Request {
    ...
    private nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder builderBr;
    private nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder builderLe;
    ...
    public Request(HuaweiSupportProvider supportProvider, nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder builder) {
    ...
    public Request(HuaweiSupportProvider supportProvider, nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder builder) {
        this.supportProvider = supportProvider;
        this.paramsProvider = supportProvider.getParamsProvider();
        assert supportProvider.isBLE();
