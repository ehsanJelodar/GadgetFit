...
package nodomain.freeyourgadget.gadgetfit.service.devices.moyoung;
...
import nodomain.freeyourgadget.gadgetfit.activities.HeartRateUtils;
...
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventUpdatePreferences;
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventVersionInfo;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.AbstractMoyoungDeviceCoordinator;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.MoyoungConstants;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.MoyoungWeatherForecast;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.MoyoungWeatherToday;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungActivitySampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungBloodPressureSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungHeartRateSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungSleepStageSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungSpo2SampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.samples.MoyoungStressSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungEnumDeviceVersion;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungEnumLanguage;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungEnumMetricSystem;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungEnumTimeSystem;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungSetting;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungSettingEnum;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungSettingRemindersToMove;
import nodomain.freeyourgadget.gadgetfit.devices.moyoung.settings.MoyoungSettingTimeRange;
...
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungActivitySample;
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungBloodPressureSample;
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungHeartRateSample;
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungSleepStageSample;
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungSpo2Sample;
import nodomain.freeyourgadget.gadgetfit.entities.MoyoungStressSample;
...
import nodomain.freeyourgadget.gadgetfit.service.btle.profiles.battery.BatteryInfo;
...
import nodomain.freeyourgadget.gadgetfit.service.btle.profiles.heartrate.HeartRateProfile;
...
//                broadcastSample(sample);
    ...
    private void handleGetAlarmsResponse(byte[] payload) {
        ...
        for (int i = alarmsInPacket; i <= coordinator.getAlarmSlotCount(getDevice()); i++) {
            nodomain.freeyourgadget.gadgetfit.entities.Alarm alarm = new nodomain.freeyourgadget.gadgetfit.entities.Alarm();
