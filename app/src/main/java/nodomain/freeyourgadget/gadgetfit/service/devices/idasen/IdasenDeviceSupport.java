...
package nodomain.freeyourgadget.gadgetfit.service.devices.idasen;
...
import nodomain.freeyourgadget.gadgetfit.devices.idasen.IdasenConstants;
...
public class IdasenDeviceSupport extends AbstractBTLESingleDeviceSupport {
    ...
    public static final String COMMAND_UP = "nodomain.freeyourgadget.gadgetfit.idasen.command.UP";
    public static final String COMMAND_DOWN = "nodomain.freeyourgadget.gadgetfit.idasen.command.DOWN";
    public static final String COMMAND_SET_HEIGHT = "nodomain.freeyourgadget.gadgetfit.idasen.command.SET_HEIGHT";
    public static final String COMMAND_GET_DESK_VALUES = "nodomain.freeyourgadget.gadgetfit.idasen.command.GET_DESK_VALUES";
