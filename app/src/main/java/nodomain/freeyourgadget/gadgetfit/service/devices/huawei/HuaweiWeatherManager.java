...
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendGpsAndTimeToDeviceRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherCurrentRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherDeviceRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherErrorRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherExtendedSupportRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherForecastRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherStartRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherSunMoonSupportRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherSupportRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendWeatherUnitRequest;
...
public class HuaweiWeatherManager {
    ...
    public void handleAsyncMessage(HuaweiPacket response) {
        if (response.getTlv().getInteger(0x7f, -1) == 0x000186AA) {
            // Send weather
            final WeatherSpec weatherSpec = nodomain.freeyourgadget.gadgetfit.model.weather.Weather.getWeatherSpec();
            if (weatherSpec == null) {
