...
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.CreateFileMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.DownloadRequestMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.FileTransferDataMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.FilterMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.GFDIMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.SynchronizationMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.SystemEventMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.UploadRequestMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.CreateFileStatusMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.DownloadRequestStatusMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.FileTransferDataStatusMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.FilterStatusMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.UploadRequestStatusMessage;
