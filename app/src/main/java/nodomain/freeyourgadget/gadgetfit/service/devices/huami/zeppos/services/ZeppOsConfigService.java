...
import static nodomain.freeyourgadget.gadgetfit.capabilities.password.PasswordCapabilityImpl.PREF_PASSWORD;
import static nodomain.freeyourgadget.gadgetfit.capabilities.password.PasswordCapabilityImpl.PREF_PASSWORD_ENABLED;
...
import static nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.ZeppOsConfigService.ConfigArg.LANGUAGE;
import static nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.ZeppOsConfigService.ConfigArg.LANGUAGE_FOLLOW_PHONE;
...
import nodomain.freeyourgadget.gadgetfit.capabilities.GpsCapability;
import nodomain.freeyourgadget.gadgetfit.capabilities.WorkoutDetectionCapability;
...
import nodomain.freeyourgadget.gadgetfit.devices.huami.AlwaysOnDisplay;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.ZeppOsMenuType;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.ZeppOsSupport;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.HuamiLanguageType;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.AbstractZeppOsService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.ZeppOsTransactionBuilder;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigIntUnbound;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigBoolean;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigByte;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigByteList;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigDatetimeHhMm;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigInt;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigShort;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigShortList;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigString;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigStringList;
import nodomain.freeyourgadget.gadgetfit.service.devices.huami.zeppos.services.config.ConfigTimestamp;
import nodomain.freeyourgadget.gadgetfit.util.GB;
import nodomain.freeyourgadget.gadgetfit.util.MapUtils;
