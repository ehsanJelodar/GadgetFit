...
package nodomain.freeyourgadget.gadgetfit.service.devices.asteroidos;
...
import nodomain.freeyourgadget.gadgetfit.devices.asteroidos.AsteroidOSConstants;
import nodomain.freeyourgadget.gadgetfit.devices.asteroidos.AsteroidOSMediaCommand;
import nodomain.freeyourgadget.gadgetfit.devices.asteroidos.AsteroidOSNotification;
import nodomain.freeyourgadget.gadgetfit.devices.asteroidos.AsteroidOSScreenshotHandler;
import nodomain.freeyourgadget.gadgetfit.devices.asteroidos.AsteroidOSWeather;
...
public class AsteroidOSDeviceSupport extends AbstractBTLESingleDeviceSupport {
    ...
    private void handleBatteryInfo(@NonNull nodomain.freeyourgadget.gadgetfit.service.btle.profiles.battery.BatteryInfo info) {
