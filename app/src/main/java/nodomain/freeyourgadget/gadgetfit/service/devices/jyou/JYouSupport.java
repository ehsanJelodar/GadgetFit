...
package nodomain.freeyourgadget.gadgetfit.service.devices.jyou;
...
import nodomain.freeyourgadget.gadgetfit.devices.jyou.JYouConstants;
...
public class JYouSupport extends AbstractBTLESingleDeviceSupport {
    ...
    public void onFindDevice(boolean start) {
        if (start) {
            showNotification(JYouConstants.ICON_QQ, "gadgetfit", "Bzzt! Bzzt!");
