...
package nodomain.freeyourgadget.gadgetfit.service.devices.gloryfit
...
import nodomain.freeyourgadget.gadgetfit.util.kotlin.coerceIn
...
class GloryFitSupport() : AbstractBTLESingleDeviceSupport(LOG) {
    ...
    private fun encodeContact(name: String, number: String): ByteArray? {
        ...
        val nameBytes = nodomain.freeyourgadget.gadgetfit.util.StringUtils.truncateUtf16BE(name, 20)
    ...
    override fun onSetCannedMessages(cannedMessagesSpec: CannedMessagesSpec) {
        ...
        for ((i, message) in cannedMessagesSpec.cannedMessages.withIndex()) {
            ...
            val messageBytes = nodomain.freeyourgadget.gadgetfit.util.StringUtils.truncate(message, 24).toByteArray()
    ...
    private fun sendNotification(
        ...
        val truncatedPayload = nodomain.freeyourgadget.gadgetfit.util.StringUtils.truncateUtf16BE(content, 240)
        var byteIdx = 0
        var chunkIdx = 0
