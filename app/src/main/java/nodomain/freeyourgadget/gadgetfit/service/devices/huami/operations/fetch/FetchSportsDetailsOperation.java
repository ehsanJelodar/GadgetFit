...
package nodomain.freeyourgadget.gadgetfit.service.devices.huami.operations.fetch;
...
public class FetchSportsDetailsOperation extends AbstractFetchOperation {
    ...
    protected boolean processBufferedData() {
        ...
        try {
            ...
            final String fileName = FileUtils.makeValidFileName("gadgetfit-" + trackType.toLowerCase() + "-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
