...
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.MessageWriter;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.NotificationControlMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.NotificationDataMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.NotificationUpdateMessage;
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.messages.status.NotificationDataStatusMessage;
...
//        LOG.info("ATTRIBUTE:{} value:{}/{} length:{}", entry.getKey(), new String(bytes), GB.hexdump(bytes), bytes.length);
    ...
    public NotificationUpdateMessage onSetCallState(CallSpec callSpec) {
        if (!enabled)
            return null;
        final int id = StringUtils.firstNonBlank(callSpec.number, "gadgetfit Call").hashCode();
