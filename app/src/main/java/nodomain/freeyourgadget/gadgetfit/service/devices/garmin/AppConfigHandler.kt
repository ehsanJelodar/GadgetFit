...
import nodomain.freeyourgadget.gadgetfit.activities.appmanager.config.DynamicAppConfig.AppConfigBoolean
import nodomain.freeyourgadget.gadgetfit.activities.appmanager.config.DynamicAppConfig.AppConfigFloat
import nodomain.freeyourgadget.gadgetfit.activities.appmanager.config.DynamicAppConfig.AppConfigInteger
import nodomain.freeyourgadget.gadgetfit.activities.appmanager.config.DynamicAppConfig.AppConfigString
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventAppConfig
import nodomain.freeyourgadget.gadgetfit.proto.garmin.GdiAppConfigService
import nodomain.freeyourgadget.gadgetfit.proto.garmin.GdiAppConfigService.AppConfigService.AppConfig
import nodomain.freeyourgadget.gadgetfit.proto.garmin.GdiSmartProto
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.http.GarminJson
import nodomain.freeyourgadget.gadgetfit.service.devices.garmin.http.GarminJsonException
import nodomain.freeyourgadget.gadgetfit.util.UuidUtil
import nodomain.freeyourgadget.gadgetfit.util.protobuf.buildWith
