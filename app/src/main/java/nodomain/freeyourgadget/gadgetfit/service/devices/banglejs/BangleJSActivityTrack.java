...
import nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSActivityPoint;
import nodomain.freeyourgadget.gadgetfit.devices.banglejs.BangleJSWorkoutParser;
...
class BangleJSActivityTrack {
    ...
    private static void parseFetchedRecorderCSV(File dir, String filename, String log, GBDevice device, Context context) {
        ...
        try {
            ...
            String fileName = FileUtils.makeValidFileName("gadgetfit-" + trackType.toLowerCase() + "-" + summary.getName() + ".gpx");
            dir = new File(FileUtils.getExternalFilesDir() + "/" + FileUtils.makeValidFileName(device.getName()));
