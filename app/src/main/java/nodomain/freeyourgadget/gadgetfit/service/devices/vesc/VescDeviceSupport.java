...
package nodomain.freeyourgadget.gadgetfit.service.devices.vesc;
...
public class VescDeviceSupport extends VescBaseDeviceSupport {
    ...
    public static final String COMMAND_SET_RPM = "nodomain.freeyourgadget.gadgetfit.vesc.command.SET_RPM";
    public static final String COMMAND_SET_CURRENT = "nodomain.freeyourgadget.gadgetfit.vesc.command.SET_CURRENT";
    public static final String COMMAND_SET_BREAK_CURRENT = "nodomain.freeyourgadget.gadgetfit.vesc.command.SET_BREAK_CURRENT";
    public static final String COMMAND_GET_VALUES = "nodomain.freeyourgadget.gadgetfit.vesc.command.GET_VALUES";
    ...
    public static final String ACTION_GOT_VALUES = "nodomain.freeyourgadget.gadgetfit.vesc.action.GOT_VALUES";
