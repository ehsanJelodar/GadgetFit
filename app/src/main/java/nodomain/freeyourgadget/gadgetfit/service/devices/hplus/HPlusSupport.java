...
package nodomain.freeyourgadget.gadgetfit.service.devices.hplus;
...
import nodomain.freeyourgadget.gadgetfit.devices.hplus.HPlusConstants;
import nodomain.freeyourgadget.gadgetfit.devices.hplus.HPlusCoordinator;
import nodomain.freeyourgadget.gadgetfit.devices.hplus.HPlusWeatherCode;
    ...
    public void onSetConstantVibration(int intensity) {
        try {
            ...
            for (int i = 0; i < msg.length - 1; i++)
                msg[i + 1] = (byte) "gadgetfit".charAt(i);
