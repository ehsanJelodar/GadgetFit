...
package nodomain.freeyourgadget.gadgetfit.service.devices.huawei;

import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ACTIVITY_REMINDER_GOAL_REACHED;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ACTIVITY_REMINDER_PROGRESS;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ACTIVITY_REMINDER_STAND;
import static nodomain.freeyourgadget.gadgetfit.model.ActivityUser.PREF_USER_GOAL_STANDING_TIME_HOURS;
...
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventAppInfo;
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventCameraRemote;
import nodomain.freeyourgadget.gadgetfit.deviceevents.GBDeviceEventDisplayMessage;
import nodomain.freeyourgadget.gadgetfit.devices.DeviceCoordinator;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiCompatTemperatureSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiCoordinator;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiState;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiCoordinator.HuaweiDeviceType;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiCrypto;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiDeviceStateManager;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiDictTypes;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiEcgFileParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiGpsParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiPacket;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiPdrParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiSequenceDataFileParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiSleepStageSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiSleepStatsSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiStressParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiStressSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiTruSleepParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiTrueSleepSequenceDataParser;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.CameraRemote;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.GpsAndTime;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.Notifications;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.Weather;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.Workout;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.ui.HuaweiStressCalibrationFragment;
...
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiActivitySample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiEcgDataSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiEcgDataSampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiEcgSummarySample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiEcgSummarySampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiSleepStageSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiSleepStatsSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiStressSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutDataSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutDataSampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutPaceSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutPaceSampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSectionsSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSectionsSampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSpO2Sample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSpO2SampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSummaryAdditionalValuesSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSummaryAdditionalValuesSampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSummarySample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSummarySampleDao;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSwimSegmentsSample;
import nodomain.freeyourgadget.gadgetfit.entities.HuaweiWorkoutSwimSegmentsSampleDao;
import nodomain.freeyourgadget.gadgetfit.export.ActivityTrackExporter;
import nodomain.freeyourgadget.gadgetfit.export.GPXExporter;
import nodomain.freeyourgadget.gadgetfit.externalevents.gps.GBLocationProviderType;
import nodomain.freeyourgadget.gadgetfit.externalevents.gps.GBLocationService;
import nodomain.freeyourgadget.gadgetfit.impl.GBDevice;
import nodomain.freeyourgadget.gadgetfit.entities.Alarm;
import nodomain.freeyourgadget.gadgetfit.entities.DaoSession;
import nodomain.freeyourgadget.gadgetfit.entities.Device;
import nodomain.freeyourgadget.gadgetfit.entities.User;
import nodomain.freeyourgadget.gadgetfit.impl.GBDeviceApp;
import nodomain.freeyourgadget.gadgetfit.model.ActivityPoint;
import nodomain.freeyourgadget.gadgetfit.model.ActivitySample;
import nodomain.freeyourgadget.gadgetfit.model.ActivityTrack;
import nodomain.freeyourgadget.gadgetfit.model.ActivityUser;
import nodomain.freeyourgadget.gadgetfit.model.CalendarEventSpec;
import nodomain.freeyourgadget.gadgetfit.model.CallSpec;
import nodomain.freeyourgadget.gadgetfit.model.CannedMessagesSpec;
import nodomain.freeyourgadget.gadgetfit.model.Contact;
import nodomain.freeyourgadget.gadgetfit.model.GPSCoordinate;
import nodomain.freeyourgadget.gadgetfit.model.MusicSpec;
import nodomain.freeyourgadget.gadgetfit.model.MusicStateSpec;
import nodomain.freeyourgadget.gadgetfit.model.NavigationInfoSpec;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncNotificationPictures;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncArrhythmia;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncEcg;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncFeatureManager;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncEmotion;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncFindDevice;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncGoals;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncArterialStiffnessDetection;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.datasync.HuaweiDataSyncSleepApnea;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PAppIcon;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PCalendarService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PCannedRepliesService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PContactsService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PDirection;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PTrackService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.HuaweiP2PDataDictionarySyncService;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.p2p.dictionarysync.HuaweiDictionarySyncInterface;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.AcceptAgreementsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetAppInfoParams;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetContactsCount;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetEventAlarmList;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetGpsParameterRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetExtendedMusicInfoParams;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetMusicInfoParams;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetNotificationConstraintsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetOTAChangeLog;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetSmartAlarmList;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetWatchfaceParams;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetWorkoutCapability;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetWorkoutTotalsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendCameraRemoteSetupEvent;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendCountryCodeRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendDeviceReportThreshold;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendExtendedAccountRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendFitnessUserInfoRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendGetDefaultSwitch;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendGpsDataRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendFileUploadInfo;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendHeartRateZonesConfig;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendOTASetAutoUpdate;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendReverseCapabilitiesRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendRunPaceConfigRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendSetContactsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendNotifyHeartRateCapabilityRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendNotifyRestHeartRateCapabilityRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendSetECGOpenRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendSleepBreathRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetAutomaticHeartrateRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetAutomaticSpoRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetDisconnectNotification;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetHeartRateHighAlert;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetHeartRateLowAlert;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetMediumToStrengthThresholdRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetSkinTemperatureMeasurement;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetSpO2LowAlert;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetStressRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetTemperatureUnitSetting;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.StopFindPhoneRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.StopNotificationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetFitnessTotalsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetHiChainRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetSleepDataCountRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetStepDataCountRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetWorkoutCountRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendNotificationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetMusicRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.AlarmsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.DebugRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetActivityTypeRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.Request;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.Request.RequestCallback;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetAuthRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetBatteryLevelRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetBondParamsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetBondRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetConnectStatusRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetDeviceStatusRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetDndLiftWristTypeRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetLinkParamsRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetPincodeRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetProductInformationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetSecurityNegotiationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetSettingRelatedRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetSupportedServicesRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetWearStatusRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendDndAddRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendFactoryResetRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendFitnessGoalRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendMenstrualCapabilityRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendDndDeleteRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SendSetUpDeviceStatusRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetActivateOnLiftRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetActivityReminderRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetDateFormatRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetLanguageSettingRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetNotificationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetNavigateOnRotateRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetTimeRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetTimeZoneIdRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetTruSleepRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetWearLocationRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetWearMessagePushRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.GetNotificationCapabilitiesRequest;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.requests.SetWorkModeRequest;
import nodomain.freeyourgadget.gadgetfit.service.serial.GBDeviceProtocol;
import nodomain.freeyourgadget.gadgetfit.util.DateTimeUtils;
import nodomain.freeyourgadget.gadgetfit.util.FileUtils;
import nodomain.freeyourgadget.gadgetfit.util.GB;
import nodomain.freeyourgadget.gadgetfit.util.MediaManager;
import nodomain.freeyourgadget.gadgetfit.util.StringUtils;
...
public class HuaweiSupportProvider {
    ...
    public nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder createLeTransactionBuilder(String taskName) {
        return leSupport.createTransactionBuilder(taskName);
    }

    public nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder createBrTransactionBuilder(String taskName) {
    ...
    protected nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder initializeDevice(nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder builder) {
    ...
    protected nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder initializeDevice(nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder builder) {
    ...
    protected void initializeDeviceConfigure() {
        if (isBLE()) {
            nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("Initializing");
            ...
            nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("Initializing");
    ...
    private void fetchActivityData() {
        ...
        if (isBLE()) {
            nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("FetchRecordedData");
            ...
            nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("FetchRecordedData");
    ...
    private void fetchWorkoutData() {
        ...
        if (isBLE()) {
            nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder leBuilder = createLeTransactionBuilder("FetchWorkoutData");
            leBuilder.setBusyTask(R.string.busy_task_fetch_activity_data);
            getWorkoutCountRequest = new GetWorkoutCountRequest(this, leBuilder, start, end);
        } else {
            nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder brBuilder = createBrTransactionBuilder("FetchWorkoutData");
            brBuilder.setBusyTask(R.string.busy_task_fetch_activity_data);
...
//            setWearMessagePushReq.doPerform();
    ...
    public void onSetAlarms(ArrayList<? extends nodomain.freeyourgadget.gadgetfit.model.Alarm> alarms) {
        ...
        for (nodomain.freeyourgadget.gadgetfit.model.Alarm alarm : alarms) {
    ...
    public void onSendWeather() {
        WeatherSpec weatherSpec = nodomain.freeyourgadget.gadgetfit.model.weather.Weather.getWeatherSpec();
        if (weatherSpec == null) {
