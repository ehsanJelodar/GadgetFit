...
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.packets.DeviceConfig.LinkParams;
...
public class GetLinkParamsRequest extends Request {
    ...
    public GetLinkParamsRequest(
            ...
            nodomain.freeyourgadget.gadgetfit.service.btbr.TransactionBuilder builder
    ) {
    ...
    public GetLinkParamsRequest(
            HuaweiSupportProvider support,
            nodomain.freeyourgadget.gadgetfit.service.btle.TransactionBuilder builder
    ) {
        super(support, builder);
        this.serviceId = DeviceConfig.id;
        this.commandId = LinkParams.id;
