...
import nodomain.freeyourgadget.gadgetfit.entities.NotificationFilter;
import nodomain.freeyourgadget.gadgetfit.entities.NotificationFilterDao;
import nodomain.freeyourgadget.gadgetfit.entities.NotificationFilterEntry;
import nodomain.freeyourgadget.gadgetfit.entities.NotificationFilterEntryDao;
import nodomain.freeyourgadget.gadgetfit.externalevents.notifications.GoogleMapsNotificationHandler;
import nodomain.freeyourgadget.gadgetfit.impl.GBDevice;
import nodomain.freeyourgadget.gadgetfit.model.AppNotificationType;
...
import static nodomain.freeyourgadget.gadgetfit.activities.NotificationFilterActivity.NOTIFICATION_FILTER_MODE_BLACKLIST;
import static nodomain.freeyourgadget.gadgetfit.activities.NotificationFilterActivity.NOTIFICATION_FILTER_MODE_WHITELIST;
import static nodomain.freeyourgadget.gadgetfit.activities.NotificationFilterActivity.NOTIFICATION_FILTER_SUBMODE_ALL;
import static nodomain.freeyourgadget.gadgetfit.util.StringUtils.ensureNotNull;
...
public class NotificationListener extends NotificationListenerService {
    ...
    public static final String ACTION_DISMISS
            = "nodomain.freeyourgadget.gadgetfit.notificationlistener.action.dismiss";
    public static final String ACTION_DISMISS_ALL
            = "nodomain.freeyourgadget.gadgetfit.notificationlistener.action.dismiss_all";
    public static final String ACTION_OPEN
            = "nodomain.freeyourgadget.gadgetfit.notificationlistener.action.open";
    public static final String ACTION_MUTE
            = "nodomain.freeyourgadget.gadgetfit.notificationlistener.action.mute";
    public static final String ACTION_REPLY
            = "nodomain.freeyourgadget.gadgetfit.notificationlistener.action.reply";
        ...
        if (prefs.getBoolean("notifications_ignore_low_priority", true)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && notification.getChannelId() != null) {
                ...
                try {
                    ...
                    LOG.warn("Can't call getNotificationChannels, gadgetfit needs to be registered as a companion app");
                }
            }
            if (isImportant == null) {
