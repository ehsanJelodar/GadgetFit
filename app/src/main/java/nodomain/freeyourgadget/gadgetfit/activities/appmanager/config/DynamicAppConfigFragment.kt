...
package nodomain.freeyourgadget.gadgetfit.activities.appmanager.config
...
class DynamicAppConfigFragment : AbstractPreferenceFragment() {
    ...
    companion object {
        ...
        const val ACTION_APP_CONFIG_EVENT: String = "nodomain.freeyourgadget.gadgetfit.app_config_event"
