package nodomain.freeyourgadget.gadgetfit.activities.multipoint
...
import nodomain.freeyourgadget.gadgetfit.activities.AbstractGBActivity
import nodomain.freeyourgadget.gadgetfit.databinding.ActivityMultipointPairingBinding
...
class MultipointPairingActivity : AbstractGBActivity() {
    ...
    companion object {
        ...
        const val ACTION_MULTIPOINT_DEVICE_LIST =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_DEVICE_LIST"
        const val ACTION_MULTIPOINT_STATUS_UPDATE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_STATUS_UPDATE"
        const val ACTION_MULTIPOINT_PAIRING_UPDATE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_PAIRING_UPDATE"
        const val ACTION_MULTIPOINT_ENABLE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_ENABLE"
        const val ACTION_MULTIPOINT_DISABLE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_DISABLE"
        const val ACTION_MULTIPOINT_GET_STATUS =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_GET_STATUS"
        const val ACTION_MULTIPOINT_GET_DEVICES =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_GET_DEVICES"
        const val ACTION_MULTIPOINT_CONNECT_DEVICE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_CONNECT_DEVICE"
        const val ACTION_MULTIPOINT_DISCONNECT_DEVICE =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_DISCONNECT_DEVICE"
        const val ACTION_MULTIPOINT_START_PAIRING =
            "nodomain.freeyourgadget.gadgetfit.ACTION_MULTIPOINT_START_PAIRING"
