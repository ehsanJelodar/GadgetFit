...
import nodomain.freeyourgadget.gadgetfit.util.XDatePreferenceFragment;
import nodomain.freeyourgadget.gadgetfit.util.XTimePreference;
import nodomain.freeyourgadget.gadgetfit.util.XTimePreferenceFragment;
import nodomain.freeyourgadget.gadgetfit.util.dialogs.MaterialEditTextPreferenceDialogFragment;
import nodomain.freeyourgadget.gadgetfit.util.dialogs.MaterialListPreferenceDialogFragment;
import nodomain.freeyourgadget.gadgetfit.util.dialogs.MaterialMultiSelectListPreferenceDialogFragment;
