...
import nodomain.freeyourgadget.gadgetfit.databinding.ActivityAlarmDetailsBinding;
...
import nodomain.freeyourgadget.gadgetfit.model.Alarm.ALARM_LABEL;
import nodomain.freeyourgadget.gadgetfit.model.Alarm.ALARM_SOUND;
...
public class AlarmDetails extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarm = (Alarm) getIntent().getSerializableExtra(nodomain.freeyourgadget.gadgetfit.model.Alarm.EXTRA_ALARM);
