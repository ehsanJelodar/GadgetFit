...
public class FindPhoneActivity extends AbstractGBActivity {
    ...
    public static final String ACTION_FOUND = "nodomain.freeyourgadget.gadgetfit.findphone.action.reply";
    public static final String ACTION_VIBRATE = "nodomain.freeyourgadget.gadgetfit.findphone.action.vibrate";
    public static final String ACTION_RING = "nodomain.freeyourgadget.gadgetfit.findphone.action.ring";
