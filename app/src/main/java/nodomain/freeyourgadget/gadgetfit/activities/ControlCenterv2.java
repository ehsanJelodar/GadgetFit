...
import nodomain.freeyourgadget.gadgetfit.activities.debug.DebugActivityV2;
import nodomain.freeyourgadget.gadgetfit.activities.discovery.DiscoveryActivityV2;
import nodomain.freeyourgadget.gadgetfit.activities.welcome.WelcomeActivity;
...
import nodomain.freeyourgadget.gadgetfit.util.GBChangeLog;
...
public class ControlCenterv2 extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull final MenuItem item) {
        ...
        if (itemId == R.id.action_settings) {
            ...
            final Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://liberapay.com/gadgetfit")); //TODO: centralize if ever used somewhere else
