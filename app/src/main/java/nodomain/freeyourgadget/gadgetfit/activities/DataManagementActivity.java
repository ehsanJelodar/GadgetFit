...
import nodomain.freeyourgadget.gadgetfit.activities.files.FileManagerActivity;
...
import nodomain.freeyourgadget.gadgetfit.util.ImportExportSharedPreferences;
...
public class DataManagementActivity extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backupToZipButton.setOnClickListener(v -> {
            ...
            final String defaultFilename = String.format(Locale.ROOT, "gadgetfit_%s.zip", sdf.format(new Date()));
