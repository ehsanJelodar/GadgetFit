...
class NotificationsDebugFragment : AbstractDebugFragment() {
    ...
    private fun sendNotificationSpec() {
        ...
        notificationSpec.key = sharedPreferences.getString(PREF_DEBUG_NOTIFICATIONS_KEY, "0|nodomain.freeyourgadget.gadgetfit|-493519667|null|10679")
        ...
        notificationSpec.sourceName = sharedPreferences.getString(PREF_DEBUG_NOTIFICATIONS_SOURCENAME, "gadgetfit")
    ...
    private fun createTestNotification() {
        ...
        val builder: NotificationCompat.Builder =
            NotificationCompat.Builder(requireContext(), GB.NOTIFICATION_CHANNEL_ID)
                ...
                .setContentText(getString(R.string.this_is_a_test_notification_from_gadgetfit))
                .setTicker(getString(R.string.this_is_a_test_notification_from_gadgetfit))
