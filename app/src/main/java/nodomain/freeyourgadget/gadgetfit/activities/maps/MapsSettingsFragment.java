...
public class MapsSettingsFragment extends AbstractPreferenceFragment {
    ...
    public static final String ACTION_SETTING_CHANGE = "nodomain.freeyourgadget.gadgetfit.maps.setting_change";
    public static final String EXTRA_SETTING_KEY = "nodomain.freeyourgadget.gadgetfit.maps_setting_key";
