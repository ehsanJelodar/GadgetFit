...
import nodomain.freeyourgadget.gadgetfit.service.devices.gree.GreeAcPrefs;
...
public class GreeAcPairingActivity extends AbstractGBActivity {
    ...
    public static final String ACTION_BIND_STATUS = "nodomain.freeyourgadget.gadgetfit.gree.bind_status";
