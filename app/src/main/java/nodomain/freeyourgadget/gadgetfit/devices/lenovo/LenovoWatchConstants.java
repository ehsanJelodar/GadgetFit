...
public class LenovoWatchConstants {
    ...
    public static final String ACTION_CALIBRATION
            = "nodomain.freeyourgadget.gadgetfit.devices.action.lenovowatch.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "nodomain.freeyourgadget.gadgetfit.devices.action.lenovowatch.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "nodomain.freeyourgadget.gadgetfit.devices.action.lenovowatch.keep_calibrating";
