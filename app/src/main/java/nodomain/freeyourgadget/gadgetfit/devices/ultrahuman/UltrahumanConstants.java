...
public final class UltrahumanConstants {
    ...
    public static final String ACTION_AIRPLANE_MODE = "nodomain.freeyourgadget.gadgetfit.ultrahuman.action.AIRPLANE_MODE";
    public static final String ACTION_CHANGE_EXERCISE = "nodomain.freeyourgadget.gadgetfit.ultrahuman.action.CHANGE_EXERCISE";
    public static final String ACTION_EXERCISE_UPDATE = "nodomain.freeyourgadget.gadgetfit.ultrahuman.action.EXERCISE_UPDATE";
