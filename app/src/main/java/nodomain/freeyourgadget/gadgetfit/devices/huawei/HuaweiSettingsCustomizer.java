...
import nodomain.freeyourgadget.gadgetfit.activities.heartratezones.HeartRateSettingsActivity;
import nodomain.freeyourgadget.gadgetfit.devices.huawei.ui.HuaweiStressCalibrationActivity;
import nodomain.freeyourgadget.gadgetfit.impl.GBDevice;
import nodomain.freeyourgadget.gadgetfit.service.devices.huawei.HuaweiWorkoutGbParser;
import nodomain.freeyourgadget.gadgetfit.util.GB;
import nodomain.freeyourgadget.gadgetfit.util.Prefs;
import nodomain.freeyourgadget.gadgetfit.util.XTimePreference;
...
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ARRHYTHMIA_ALERT;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ARRHYTHMIA_AUTOMATIC;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ARRHYTHMIA_SWITCH;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_DEBUG_REQUEST;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_CONTINUOUS_SKIN_TEMPERATURE_MEASUREMENT;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ECG_SWITCH;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_HEART_RATE_HIGH_ALERT;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_HEART_RATE_LOW_ALERT;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_HEART_RATE_REALTIME_MODE;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_SLEEP_BREATH;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_SPO_LOW_ALERT;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_STRESS_CALIBRATE;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_STRESS_SWITCH;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_TRUSLEEP;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_WORKMODE;
import static nodomain.freeyourgadget.gadgetfit.devices.huawei.HuaweiConstants.PREF_HUAWEI_ARTERIAL_STIFFNESS_DETECTION_SWITCH;
