...
package nodomain.freeyourgadget.gadgetfit.devices.test;
...
import nodomain.freeyourgadget.gadgetfit.capabilities.widgets.WidgetManager;
import nodomain.freeyourgadget.gadgetfit.devices.AbstractDeviceCoordinator;
...
import nodomain.freeyourgadget.gadgetfit.devices.roidmi.RoidmiConst;
import nodomain.freeyourgadget.gadgetfit.devices.test.activity.TestActivitySummaryParser;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestBodyEnergySampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestHrvSummarySampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestHrvValueSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestPaiSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestRespiratoryRateSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestSpo2SampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestStressSampleProvider;
import nodomain.freeyourgadget.gadgetfit.devices.test.samples.TestTemperatureSampleProvider;
...
import nodomain.freeyourgadget.gadgetfit.model.AbstractNotificationPattern;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.test.TestDeviceSupport;
