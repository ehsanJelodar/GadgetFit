...
import nodomain.freeyourgadget.gadgetfit.entities.HybridHRSpo2SampleDao;
...
import nodomain.freeyourgadget.gadgetfit.service.devices.qhybrid.parser.HybridHRWorkoutSummaryParser;
...
public class QHybridCoordinator extends AbstractBLEDeviceCoordinator {
    ...
    public String getAuthHelp() {
        return "https://gadgetfit.org/basics/pairing/fossil-server/";
    }
