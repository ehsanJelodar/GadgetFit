...
import nodomain.freeyourgadget.gadgetfit.service.receivers.GBCallControlReceiver;
...
public class GBDeviceEventCallControl extends GBDeviceEvent {
    ...
    public void evaluate(final Context context, final GBDevice device) {
        ...
        if (event == GBDeviceEventCallControl.Event.IGNORE) {
            ...
            final Intent broadcastIntent = new Intent("nodomain.freeyourgadget.gadgetfit.MUTE_CALL");
