...
import nodomain.freeyourgadget.gadgetfit.activities.FindPhoneActivity;
...
public class GBDeviceEventFindPhone extends GBDeviceEvent {
    ...
    private void handleGBDeviceEventFindPhoneStartNotification(final Context context, final boolean ring) {
        ...
        if (manager.getAssociations().isEmpty()) {
            ...
            final Intent instructionsIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://gadgetfit.org/basics/pairing/companion-device/"));
