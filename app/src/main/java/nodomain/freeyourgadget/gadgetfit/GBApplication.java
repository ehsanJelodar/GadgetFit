...
package nodomain.freeyourgadget.gadgetfit;

import static nodomain.freeyourgadget.gadgetfit.util.GB.NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID;
import static nodomain.freeyourgadget.gadgetfit.util.GB.NOTIFICATION_ID_ERROR;
...
import nodomain.freeyourgadget.gadgetfit.database.DBOpenHelper;
...
import nodomain.freeyourgadget.gadgetfit.entities.DaoMaster;
import nodomain.freeyourgadget.gadgetfit.externalevents.BluetoothStateChangeReceiver;
import nodomain.freeyourgadget.gadgetfit.externalevents.opentracks.OpenTracksContentObserver;
...
import nodomain.freeyourgadget.gadgetfit.model.weather.WeatherCacheManager;
import nodomain.freeyourgadget.gadgetfit.prefs.GBPrefsMigrator;
import nodomain.freeyourgadget.gadgetfit.service.NotificationCollectorMonitorService;
import nodomain.freeyourgadget.gadgetfit.util.AndroidUtils;
import nodomain.freeyourgadget.gadgetfit.util.BondingUtil;
...
import nodomain.freeyourgadget.gadgetfit.util.PermissionsUtils;
...
import nodomain.freeyourgadget.gadgetfit.util.healthconnect.HealthConnectPermissionManager;
...
public class GBApplication extends Application {
    ...
    public static final String DATABASE_NAME = "gadgetfit";
    ...
    public static final String ACTION_QUIT
            = "nodomain.freeyourgadget.gadgetfit.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "nodomain.freeyourgadget.gadgetfit.gbapplication.action.language_change";
    public static final String ACTION_THEME_CHANGE = "nodomain.freeyourgadget.gadgetfit.gbapplication.action.theme_change";
    public static final String ACTION_NEW_DATA = "nodomain.freeyourgadget.gadgetfit.action.new_data";
    public static final String ACTION_APP_IS_IN_FOREGROUND = "nodomain.freeyourgadget.gadgetfit.action.app_foreground";
    public static final String ACTION_APP_IS_IN_BACKGROUND = "nodomain.freeyourgadget.gadgetfit.action.app_background";
    ...
    public static void quit() {
        GB.log("Quitting gadgetfit...", GB.INFO, null);
    ...
    public static void restart() {
        GB.log("Restarting gadgetfit...", GB.INFO, null);
        BondingUtil.StopObservingAll(getContext());
    ...
    private void startNotificationCollectorMonitorService() {
        ...
        try {
            ...
            final Intent instructionsIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://gadgetfit.org/basics/topics/background-service/"));
    ...
    public static String getLogPath() {
        ...
        if (path == null) {
            ...
            try {
                path = logging.createLogDirectory() + File.separator + "gadgetfit.log";
    ...
    public String getVersion() {
        try {
            ...
            GB.log("Unable to determine gadgetfit's version", GB.WARN, e);
            return "0.0.0";
        }
    }
    ...
    public String getNameAndVersion() {
        try {
            ...
            GB.log("Unable to determine gadgetfit's name/version", GB.WARN, e);
            return "gadgetfit";
        }
    }
