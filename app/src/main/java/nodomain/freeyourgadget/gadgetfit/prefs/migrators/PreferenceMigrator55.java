package nodomain.freeyourgadget.gadgetfit.prefs.migrators;

import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.AMAZFITBIP;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.AMAZFITCOR;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.AMAZFITCOR2;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.FITPRO;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.GALAXY_BUDS;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.LEFUN;
import static nodomain.freeyourgadget.gadgetfit.model.DeviceType.MIBAND;
...
import nodomain.freeyourgadget.gadgetfit.prefs.AbstractPreferenceMigrator;
...
public class PreferenceMigrator55 extends AbstractPreferenceMigrator {
    ...
    public void migrate(final int oldVersion, final SharedPreferences sharedPrefs, final SharedPreferences.Editor editor) {
        ...
        if (oldVersion < 6) {
            ...
            migrateStringPrefToPerDevicePref("mi_button_press_broadcast", "nodomain.freeyourgadget.gadgetfit.ButtonPressed", "button_action_broadcast", new ArrayList<>(Collections.singletonList(MIBAND2)));
        }
        if (oldVersion < 7) {
